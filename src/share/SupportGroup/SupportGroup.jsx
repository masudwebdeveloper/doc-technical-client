   ...
   return (
      <section className="light:bg-gray-800 light:text-gray-100">
         <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
            <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-xl  lg:text-left" data-aos="fade-right" data-aos-duration="2000">
               <h1 className="text-3xl font-bold leading-none sm:text-3xl">Staying for round the clock support<br/> 
            ...
            <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128" data-aos="fade-left" data-aos-duration="2000">
