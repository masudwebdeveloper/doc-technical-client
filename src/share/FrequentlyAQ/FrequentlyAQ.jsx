...
const FrequentlyAQ = () => {
   return (
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-1 p-5'>
         <section className="dark:bg-gray-800 dark:text-gray-100 rounded-tl-md rounded-br-md rounded-tr-3xl rounded-bl-3xl" data-aos="fade-right" data-aos-duration="2000">
            <div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
               <img src={faq} alt="" />
               <h1 className="text-4xl font-bold leading-none sm:text-4xl">Frequently asked questions <br />
                  <span className="dark:text-violet-400">Answer the question</span>
               </h1>
               <p className="px-8 mt-8 mb-12 text-lg">We have listed here the answers to some of your common questions. We request you to read this list once before asking questions. Then you don't have to wait for our reply and save your precious time.</p>
            </div>
         </section>
         <section className="dark:bg-gray-800 dark:text-gray-100 p-5 lg:p-10 rounded-tl-3xl rounded-br-3xl rounded-tr-md rounded-bl-md" data-aos="fade-left" data-aos-duration="2000">
            <div className="flex flex-col mt-0 lg:mt-20">
               <div className="flex flex-col divide-y divide-gray-700">
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">How will the course videos be given?</summary>
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">How to participate in the course tests?</summary>
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">How long will the course last?</summary>
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">What do you need to do the course?</summary>
                     <div className="px-4 pb-4 space-y-2">
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">Does the course fee have to be paid in full before the course?</summary>
                     <div className="px-4 pb-4 space-y-2">
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">Are course fees refundable?</summary>
                     <div className="px-4 pb-4 space-y-2">
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">Will any discount be given on the course fee?</summary>
                     <div className="px-4 pb-4 space-y-2">
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">What to do if you get stuck while doing the course?</summary>
                     <div className="px-4 pb-4 space-y-2">
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">Unable to pay course fee. what to do?</summary>
                     <div className="px-4 pb-4 space-y-2">
                  ...
                  <details>
                     <summary className="py-2 font-semibold text-xl outline-none cursor-pointer focus:underline">My question is not answered here. Where to ask questions?</summary>
                     <div className="px-4 pb-4 space-y-2">
