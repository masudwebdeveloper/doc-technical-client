         ...
         <div className="max-w-md mx-auto mt-10 p-8 space-y-3 rounded-xl dark:bg-slate-900 dark:text-gray-100">
            ...
            <form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
               <div className="space-y-1 text-sm">
                  <label for="username" className="bloc font-bold text-mdk text-light-400 mb-3">Username</label>
               ...
               <div className="space-y-1 text-sm">
                  <label for="userphotourl" className="block font-bold text-md text-light-400 mb-3">UserPhotoURL</label>
               ...
               <div className="space-y-1 text-sm">
                  <label for="useremail" className="block font-bold text-md text-light-400 mb-3">Useremail</label>
               ...
               <div className="space-y-1 text-sm">
                  <label for="password" className="block font-bold text-md text-light-900 mb-3">Password</label>
