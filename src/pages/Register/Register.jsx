...
const Register = () => {
   ...
   const { createUser,signInWithGithub, verifyEmail, userUpdateProfile, setUser, signInWithGoogle, signInWithFacebook } = useContext(AuthContext);
   ...
   return (
      <div className="max-w-lg mx-auto my-10 p-8 space-y-3 rounded-xl dark:bg-slate-900 dark:text-gray-100">
         <h1 className="text-4xl font-bold text-center">Please Register</h1>
         <form onSubmit={handleSubmit} className="space-y-6 ng-untouched ng-pristine ng-valid">
            <div className="space-y-1 text-sm">
               <label htmlFor="username" className="block text-xl font-bold text-md text-light-400 mb-3">Username</label>
            ...
            <div className="space-y-1 text-sm">
               <label htmlFor="userphotourl" className="block text-xl font-bold text-md text-light-400 mb-3">UserPhotoURL</label>
            ...
            <div className="space-y-1 text-sm">
               <label htmlFor="useremail" className="block text-xl font-bold text-md text-light-400 mb-3">Useremail</label>
            ...
            <div className="space-y-1 text-sm">
               <label htmlFor="password" className="block text-xl font-bold text-md text-light-900 mb-3">Password</label>
