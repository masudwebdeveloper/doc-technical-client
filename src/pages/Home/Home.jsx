      ...
      <div>
         ...
         <section className="light:bg-gray-800 dark:text-gray-800 lg:px-20 pb-5">
            ...
            <div className="container mx-auto px-5 lg:p-10 grid grid-flow-col-1 lg:grid-cols-4 gap-4">
               <div className="lg:row-span-4 col-span-4 lg:col-span-2 bg-gray-800 rounded-xl flex flex-col p-5 " data-aos="fade-left">
               ...
               <div className="col-span-4 lg:col-span-2 row-span-2 flex items-center bg-gray-800 rounded-xl " data-aos="fade-up">
               ...
               <div className="col-span-4 lg:col-span-2 row-span-2 flex items-center bg-gray-800 rounded-xl" data-aos="fade-down">
