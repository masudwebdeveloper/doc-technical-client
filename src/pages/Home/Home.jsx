      ...
      <div className='overflow-hidden'>
         <section className='dark:bg-gray-800 py-5 lg:py-10'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 container mx-auto  px-3' >
               <div className='flex flex-col justify-center p-5 lg:p-10' data-aos="fade-right" data-aos-duration="2000">
                  <h1 className='text-4xl lg:text-6xl mb-3 font-bold text-white'>I want work for <span className='text-amber-500'>NASA</span></h1>
                  <p className='text-lg lg:text-xl font-semibold text-white lg:my-5'>Online learning has become an integral component of higher education, as is evident by the steady emergence and growth of online course offerings and online academic and professional degree programs</p>
         ...
         <section className="light:bg-gray-800 py-5 lg:py-10 dark:text-gray-900 container mx-auto lg:px-20">
            <div className="container flex flex-col mx-auto lg:flex-row">
               ...
               <div className="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:p-12" data-aos="zoom-in-up" data-aos-duration="2000">
                  <h2 className="text-2xl lg:text-5xl font-bold leading-none uppercase">I am Masud Rana</h2>
                  <div className='border-2 mt-5'></div>
                  <p className="mt-4 mb-8 text-md lg:text-lg"><span>Hey,</span> <br />Thanks for stopping by. I am Masud, an web developer, font-end developer, my dream wanna to be full stack developer & entrepreneur . On an average day, I learn 10 hours of web programming!!</p>
         ...
         <section className="lg:py-10 dark:bg-gray-800 dark:text-gray-100">
            <div className="container mx-auto p-4 my-6 space-y-2 text-center" data-aos="fade-down" data-aos-duration="2000">
               <h2 className="text-2xl lg:text-5xl font-bold">Whatever web development will be taught</h2>
               <p className="dark:text-gray-300 text-md lg:text-lg">Team Member with Doc Technical</p>
            </div>
         ...
         <section className="light:bg-gray-800 dark:text-gray-800 lg:px-20 pb-5">
            <div className="container mx-auto flex flex-col items-center px-5 py-10 text-center  xl:max-w-3xl" data-aos="fade-down" data-aos-duration="2000">
               <h1 className="text-2xl lg:text-4xl font-bold leading-none">Find best
            ...
            <div className="container mx-auto px-5 lg:p-10 grid grid-flow-col-1 lg:grid-cols-4 gap-4">
               ...
               <img className='w-48 mb-2 p-1 lg:p-4' src={photo3} alt="" />
                  <div className='pr-3'>
                     <h3 className='text-white text-xl lg:text-3xl font-semibold'>Productive team</h3>
                     <p className='text-white text-sm lg:text-xl'>Build high performing teams crafted just for you with the right fit for your specific requirements.</p>
                  </div>
               </div>
               ...
               <img className='w-48 mb-2 p-1 lg:p-4' src={photo4} alt="" />
                  <div className='pr-3'>
                     <h3 className='text-white text-xl lg:text-3xl font-semibold'>Futuristic Developer</h3>
                     <p className='text-white text-sm lg:text-xl'>Hire energetic Developers who are challenge takers and a quick learner.</p>
                  </div>
               </div>
            </div>
         </section>
